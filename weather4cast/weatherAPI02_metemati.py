...
api_url =  ''   # dinamically generated by function "generate_url()'
...
def generate_url():
    """
    generates url dinamically from current date until current day + WeatherConfig.DAYS.value
    :return: url
    """
    global api_url
    ...
    'T00:00:00.000+02:00:PT1H/t_2m:C,precip_1h:mm,weather_symbol_1h:idx,wind_speed_10m:ms/' + \
    WeatherConfig.GEO_LAT.value + ',' + WeatherConfig.GEO_LON.value + '/json'
    return api_url
