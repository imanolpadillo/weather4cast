...
class WeatherConfig(Enum):
    ...
    ECO_MODE_HOLIDAYS_SCHEDULE = "000000000000001111111111111111111111111111CCCCCC"
    #                    hour     000000000000000000001111111111111111111122222222
    #                             001122334455667788990011223344556677889900112233
    #                    minutes  030303030303030303030303030303030303030303030303
    #                             000000000000000000000000000000000000000000000000
    ECO_MODE_SCHEDULE = [        "000000000001100000000000000000111111111111CC0000",
    # MONDAY             hour     000000000000000000001111111111111111111122222222
    #                             001122334455667788990011223344556677889900112233
    #                    minutes  030303030303030303030303030303030303030303030303
    #                             000000000000000000000000000000000000000000000000
                                 "000000000001100000000000000000111111111111CC0000",
    # TUESDAY            hour     000000000000000000001111111111111111111122222222
    #                             001122334455667788990011223344556677889900112233
    #                    minutes  030303030303030303030303030303030303030303030303
    #                             000000000000000000000000000000000000000000000000
                                 "000000000001100000000000000000111111111111CC0000",
    # WEDNESDAY          hour     000000000000000000001111111111111111111122222222
    #                             001122334455667788990011223344556677889900112233
    #                    minutes  030303030303030303030303030303030303030303030303
    #                             000000000000000000000000000000000000000000000000
                                 "000000000001100000000000000000111111111111CC0000",
    # THURSDAY           hour     000000000000000000001111111111111111111122222222
    #                             001122334455667788990011223344556677889900112233
    #                    minutes  030303030303030303030303030303030303030303030303
    #                             000000000000000000000000000000000000000000000000
                                 "000000000001100000000000000000111111111111CCCCCC",
    # FRIDAY             hour     000000000000000000001111111111111111111122222222
    #                             001122334455667788990011223344556677889900112233
    #                    minutes  030303030303030303030303030303030303030303030303
    #                             000000000000000000000000000000000000000000000000
                                 "000000000000001111111111111111111111111111CCCCCC",
    # SATURDAY           hour     000000000000000000001111111111111111111122222222
    #                             001122334455667788990011223344556677889900112233
    #                    minutes  030303030303030303030303030303030303030303030303
    #                             000000000000000000000000000000000000000000000000
                                 "000000000000001111111111111111111111111111CC0000"]
    # SUNDAY             hour     000000000000000000001111111111111111111122222222
    #                             001122334455667788990011223344556677889900112233
    #                    minutes  030303030303030303030303030303030303030303030303
    #                             000000000000000000000000000000000000000000000000
    TREND_DISPLAY_SECONDS = 15    # seconds that trend is shown before o'clock time.
    TREND_SCHEDULE =             "111111111111111111111111"
