...
class WeatherConfig(Enum):
    ...
    ECO_MODE_SCHEDULE = [        "000000100000000111111C00","000000100000000111111C00","000000100000000111111C00",
    ...
    #                             012345678901234567890123   012345678901234567890123   012345678901234567890123
                                 "000000100000000111111C00","000000100000000111111CCC","000000011111111111111CCC",
